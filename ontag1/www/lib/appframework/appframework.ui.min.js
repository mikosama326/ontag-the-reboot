...
(function(a, h) {
    function g(a, c) {
        if (a)
            if (a.nodeType) c[c.length++] = a;
                ...
                for (var d = 0, b = a.length; d < b; d++) c[c.length++] = a[d] }
    ...
    function b(a, c) {
        ...
        a.os.webos = c.match(/(webOS|hpwOS)[\s\/]([\d.]+)/) ?
            !0 : !1;
        ...
        c.match(/IEMobile/i) && (a.each(a.os, function(c) { a.os[c] = !1 }), a.os.ie = !0, a.os.ieTouch = !0);
        for (var d = ["Webkit", "Moz", "ms", "O"], b = 0; b < d.length; b++) "" === f.documentElement.style[d[b] + "Transform"] && (a.feat.cssPrefix =
            d[b])
    }
    ...
    a.extend(a.fn, {
        vendorCss: function(c, d, b) { this.css(c.toLowerCase(), d, b);
            return this.css(a.feat.cssPrefix + c, d, b) },
        cssTranslate: function(c) { this.vendorCss("Transform", "translate" + a.feat.cssTransformStart + c + a.feat.cssTransformEnd) },
        ...
        replaceClass: function(a, c) {
            ...
            var d = function(a) { f = f.replace(a in e ? e[a] : e[a] = RegExp("(^|\\s)" + a + "(\\s|$)"), " ") },
                b = 0;
            for (; b < this.length; b++) {
    ...
    a.getCssMatrix = function(c) { a.is$(c) && (c = c.get(0));
        var d = h.WebKitCSSMatrix || h.MSCSSMatrix;
        if (void 0 === c) return d ? new d : { a: 0, b: 0, c: 0, d: 0, e: 0, f: 0 };
        c = h.getComputedStyle(c);
        c = c.webkitTransform || c.transform || c[a.feat.cssPrefix + "Transform"];
        return d ? new d(c) : c ? (d = c.replace(/[^0-9\-.,]/g, "").split(","), { a: +d[0], b: +d[1], c: +d[2], d: +d[3], e: +d[4], f: +d[5] }) : { a: 0, b: 0, c: 0, d: 0, e: 0, f: 0 } };
    a.create = function(d, b) {
        ...
        if (b || "<" !== d[0]) {
            ...
            k[k.length++] = e
        } else e = f.createElement("div"), c ? MSApp.execUnsafeLocalFunction(function() { e.innerHTML = d.trim() }) : e.innerHTML = d, g(e.childNodes, k);
        return k
    };
    a.query = function(c, d) {
        try {
            return a(c, d) } catch (b) {
            return a() } };
    ...
    h.$afm = a;
    a.feat.TouchList = function() { this.length = 0 };
    a.feat.TouchList.prototype = { item: function(a) {
            return this[a] }, _add: function(a) { this[this.length] = a;
            this.length++ } };
    var d =
        1E3;
    a.feat.Touch = function() { this.identifier = d++ };
    a.feat.Touch.prototype = { clientX: 0, clientY: 0, screenX: 0, screenY: 0, pageX: 0, pageY: 0, identifier: 0 }
})(jQuery, window);
...
(function(a) {
    var h = window.location.pathname + window.location.search,
        g = function() {
            function c() {
                ...
                // a.os.ios7 && d.overlayStatusbar &&
                    // d.ready(function() { a(document.body).addClass("overlayStatusbar") })
            }
            var d = this;
            "function" === typeof define && define.amd ? (d.autoLaunch = !1, define("appframeworkui", [], function() {
                return a.afui })) : "undefined" !== typeof module && module.exports && (d.autoLaunch = !1, a.afui = d);
            var b = function() { c();
                window.FastClick && FastClick.attach(document.documentElement) };
            if ("complete" === document.readyState || "loaded" === document.readyState)
                if (b(), d.init) d.autoBoot();
                else a(window).one("afui:init", function() { d.autoBoot() });
            ...
            window.addEventListener("popstate", function() {
                if (d.useInternalRouting) {
                    var c = d.getPanelId(document.location.hash); "#" !== document.location.href.replace(document.location.origin + "/", "") && ("" === c && 1 === d.history.length && (c = "#" + d.firstPanel.id), "" !== c && 0 !== a(c).filter(".panel").length && c !== "#" + d.activeDiv.id && d.goBack()) } }, !1);
    ...
    g.prototype = {
        ...
        autoBoot: function() { this.hasLaunched = !0;
        ...
        registerDataDirective: function(a, d) { b.push({ sel: a, cb: d }) },
        enableTabBar: function() { a(document).on("click", ".button-grouped.tabbed", function(c) {
                var d = a(c.target);
                d.closest(".tabbed").find(".button").data("ignore-pressed", "true").removeClass("pressed");
                d.closest(".button").addClass("pressed");
                setTimeout(function() { d.closest(".button").addClass("pressed") }) }) },
        disableTabBar: function() { a(document).off("click", ".button-grouped.tabbed");
        ...
        blockUI: function(c) { a.blockUI(c) },
        unblockUI: function() { a.unblockUI() },
        autoLaunch: !0,
        ready: function(c) {
            if (this.launchCompleted) c();
            else a(document).one("afui:ready", function() { c() }) },
        goBack: function(c) {
            var d =
                a(this.activeDiv).closest(".view");
            c && c.target && (d = a(c.target).closest(".view"));
            if (0 !== d.length && this.views[d.prop("id")]) {
                var b = this.views[d.prop("id")];
                if (0 !== b.length && (c = b.pop(), 0 !== c.length))
                    if (0 < b.length) {
                        if ((b = b[b.length - 1].target) && c.target !== b) this.runTransition(c.transition, c.target, b, !0), this.loadContentData(b, d, !0), this.updateHash(b.id) } else try { this.dismissView(c.target, c.transition) } catch (f) {} }
        },
        ...
        pushHistory: function(c, d, b, f) {
            try { this.manageHistory && (window.history.pushState(d, d, h + "#" + d + f), a(window).trigger("hashchange", null, { newUrl: h + "#" + d + f, oldUrl: h + c })) } catch (e) {} },
        updateHash: function(c) {
            if (this.manageHistory) { c = -1 === c.indexOf("#") ? "#" + c : c;
                var d = window.location.hash,
                    b = this.getPanelId(c).substring(1);
                try { window.history.replaceState(b, b, h + c), a(window).trigger("hashchange", null, { newUrl: h + c, oldUrl: h + d }) } catch (f) {} } },
        getPanelId: function(a) {
            var d = a.indexOf("/");
            return -1 === d ? a : a.substring(0, d)
        },
        setBackButtonText: function(c) { a(this.activeDiv).closest(".view").find("header .backButton").html(c) },
        setTitle: function(c) {
            var d = ""; "string" === typeof c ? (d = c, c = a(this.activeDiv).closest(".view")) : a(c).attr("data-title") ? d = a(c).attr("data-title") : a(c).attr("title") && (d = a(c).attr("title"));
        ...
        setBackButtonVisibility: function(c) {
            a(this.activeDiv).closest(".view").children("header").find(".backButton").css("visibility",
                c ? "visible" : "hidden")
        },
        updateBadge: function(c, d, b, f) { void 0 === b && (b = "");
            c = a(c);
            var e = c.find("span.af-badge");
            0 === e.length ? ("absolute" !== c.css("position") && c.css("position", "relative"), e = a.create("span", { className: "af-badge " + b, html: d }), c.append(e)) : e.html(d);
            e.removeClass("tl bl br tr");
            e.addClass(b);
            void 0 === f && (f = "red");
            a.isObject(f) ? e.css(f) : f && e.css("background", f);
            e.data("ignore-pressed", "true") },
        removeBadge: function(c) { a(c).find("span.af-badge").remove() },
        showMask: function(c) {
        ...
        hideMask: function() { a.query("#afui_mask").hide() },
        dismissView: function(c, d) { d = d.replace(":dismiss", "");
        ...
        loadContent: function(a, d, b, f, e) {
            this.doingTransition || (e = e || null, 0 !== a.length && (-1 !== a.indexOf("#") ? this.loadDiv(a, d, b, f, e) : this.loadAjax(a,
                d, b, f, e)))
        },
        loadDiv: function(c, d, b, f, e) {
            ...
            k = k.replace("#", "");
            if (k = a.query("#" + k).get(0))
                if (k === this.activeDiv && !b) this.doingTransition = !1;
                else {
                    ...
                    n && (e && e.get(0) !== g.get(0)) && a(e).trigger("nestedviewunload");
                    !n && (d || e && e.get(0) !== g.get(0)) ? (this.runViewTransition(f, g, e || d, k, b), this.updateViewHistory(g, k, f, c), s = !0) : (this.runTransition(f, h, k, b), this.updateViewHistory(g, k, f, c));
                    this.loadContentData(k, g, !1, s)
                }
            else a(document).trigger("missingpanel", null, { missingTarget: c }), this.doingTransition = !1
        },
        ...
        findPreviousPanel: function(c, d) {
            ...
            return b.get(0) },
        loadContentData: function(a, d, b, e) { this.activeDiv = a;
        ...
        setActiveTab: function(c, d) {
            ...
            if (!(0 === d.find("footer").find("a").filter("[href='" +
                    b + "']").length && 0 === d.find("footer").find("a").filter("[href='#" + b + "']").length)) {
                var e = d.find("footer").find("a").removeClass("pressed").attr("data-ignore-pressed", "true");
                e.filter("[href='" + b + "']").addClass("pressed");
                e.filter("[href='#" + b + "']").addClass("pressed") }
        },
        showBackButton: function(a, b) {
            var e = this.views[a.prop("id")].length,
                f = a.children("header");
            0 !== f.length && (2 <= e && !0 !== b ? 1 !== f.find(".backButton").length && f.prepend("<a class='backButton back'>Back</a>") : f.find(".backButton").remove()) },
        loadAjax: function(c, b, f, g, h) {
            var k = this,
                r = e(c),
                q = a(".panel[data-crc='" + r + "']"),
                n = h.getAttribute("data-refresh");
            if (0 < q.length)
                if (n) k.showLoading && k.showMask("Loading Content"), a.ajax(c).then(function(a) { q.html(a);
                    k.showLoading && k.hideMask();
                    return k.loadContent("#" + q.prop("id"), b, f, g, h) });
                else return k.loadContent("#" + q.prop("id"), b, f, g, h);
            k.showLoading && k.showMask("Loading Content");
            a.ajax(c).then(function(e) {
                e = a.create("div", { html: e });
                e.hasClass(".panel") ? e = e.find(".panel") : (e = a(h).attr("data-title") ?
                    e.attr("data-title", h.getAttribute("data-title")) : a(h).attr("title") ? e.attr("data-title", h.getAttribute("title")) : e.attr("data-title", c), e.prop("id", r), e.addClass("panel"));
                a(k.activeDiv).closest(".pages").append(e);
                e.attr("data-crc", r);
                k.showLoading && k.hideMask();
                k.loadContent("#" + e.prop("id"), b, f, g, h)
            }).fail(function(a) { k.showLoading && k.hideMask();
        ...
        runTransition: function(c, b, e, f, g) {
            ...
            var q = a(b).animation().remove(c + "-in");
            !e && q ? (f && q.reverse(), q.end(function() { f ? (this.classList.add("active"), a(this).trigger("panelload")) : (this.classList.remove("active"), a(this).trigger("panelunload"));
                k.doingTransition = !1 }).run(c + "-out")) : f ? (a(b).trigger("panelload"), a(b).addClass("activeDiv")) : a(b).trigger("panelunload");
            h = a(h).animation().remove(c + "-out");
            f && h.reverse();
            h.end(function() { k.doingTransition = !1;
                f ? (g && a(g).css("zIndex", "10"), this.classList.remove("active"), a(this).trigger("panelunload")) : (this.classList.add("active"), a(this).trigger("panelload"), a(g).trigger("panelload")) }).run(c + "-in")
        },
        runViewTransition: function(c, b, e, f, g) {
            b.addClass("active");
            a(f).addClass("active");
            "none" === c ? (this.doingTransition = !1, setTimeout(function() { e.removeClass("active");
                    b.addClass("active");
                    a(f).addClass("active") }, 50)) :
                this.runTransition(c, e, b, g, f)
        },
        updateViewHistory: function(a, b, e, f) {
            var g = this.views[a.prop("id")];
            g || (g = this.views[a.prop("id")] = []);
            1 <= g.length && g[g.length - 1].target === b || (this.pushHistory(b.id, b.id, e, f.replace(b.id, "").replace("#", "")), this.views[a.prop("id")].push({ target: b, transition: e })) },
        launch: function() {
            if (!1 === this.hasLaunched || this.launchCompleted) this.hasLaunched = !0;
                ...
                this.views[d.prop("id")].push({ target: g.get(0), transition: this.transitionType });
                this.defaultPanel = g.get(0);
                this.loadContentData(g.get(0), d, !1, !0);
                this.updateHash(g.get(0).id);
                this.loadDefaultHash && setTimeout(function() { this.loadContent(e, !1, 0, "none") }.bind(this));
                this.enableTabBar();
                a(document).on("click", "a", function(a) { c.useInternalRouting && f(a, a.currentTarget) });
                a(document).on("click", function(d) {
                    for (var e = b.length, f = a(d.target), g = 0; g < e; g++) {
                        var h = b[g],
                            m = f.closest(h.sel);
                        0 < m.length && h.cb.call(c, m.get(0), d)
                    }
                });
                a(document).on("click", ".backButton, [data-back]", function() { c.useInternalRouting && c.goBack(c) });
                d = a("[data-include]");
                if (0 === d.length) this.launchCompleted = !0, a(document).trigger("afui:ready");
                else {
                    var h = [];
                    d.each(function() {
                        var c = this.getAttribute("data-include"),
                            b = a(this);
                        h.push(a.get(c, function(a) { b.append(a) })) });
                    a.when.apply(a, h).then(function() { this.launchCompleted = !0;
                        a(document).trigger("afui:ready") }).fail(function() { this.launchCompleted = !0;
                        a(document).trigger("afui:ready") }) }
                a(document).on("click",
                    "footer a:not(.button)",
                    function(c) { c = a(c.target);
                        var b = c.closest("footer");
                        c.parent().find("a:not(.button)").attr("data-ignore-pressed", "true").removeClass("pressed"); "true" !== b.attr("data-ignore-pressed") && c.addClass("pressed") })
            }
        }
    };
    var f = function(c, b) {
            ...
            if (b !== document) {
                ...
                if ("a" !== b.tagName.toLowerCase() && b.parentNode) return f(c,
                    b.parentNode);
                if ("undefined" !== b.tagName && "a" === b.tagName.toLowerCase() && !(-1 !== b.href.toLowerCase().indexOf("javascript:") || b.getAttribute("data-ignore"))) {
                    ...
                    g = b.getAttribute("data-transition");
                    !g && 0 < a(b).closest("footer").length && (g = "none");
    ...
    var h = function(g, b) {
        if (this.el = "string" === typeof g || g instanceof String ? document.getElementById(g) : g) {
            if (this instanceof h) {
                if ("object" === typeof b)
                    for (var f in b) this[f] = b[f] } else return new h(g, b);
            var e;
            f = function() {};
            if ("string" === typeof b) e = a("<div id='af_actionsheet'><div style='width:100%'>" + b + "<a href='javascript:;' class='cancel'>Cancel</a></div></div>");
            else if ("object" ===
                typeof b) { e = a("<div id='af_actionsheet'><div style='width:100%'></div></div>");
                var c = a(e.children().get(0));
                b.push({ text: "Cancel", cssClasses: "cancel" });
            ...
            setTimeout(function() { e.vendorCss("Transition", "all 300ms");
                e.cssTranslate("0,0") }, 10);
            a("#af_action_mask").bind("touchstart touchmove touchend click", function(a) { a.preventDefault();
                a.stopPropagation() })
        } else window.alert("Could not find element for actionsheet " +
            g)
    };
    h.prototype = { activeSheet: null, sheetClickHandler: function() { this.hideSheet();
            return !1 }, hideSheet: function() { this.activeSheet.off("click", "a", this.sheetClickHandler);
            a(this.el).find("#af_action_mask").unbind("click").remove();
            this.activeSheet.vendorCss("Transition", "all 0ms");
            var g = this.activeSheet,
                b = this.el;
            setTimeout(function() { g.vendorCss("Transition", "all 300ms");
                g.cssTranslate("0," + (g.height() + 60) + "px");
                setTimeout(function() { g.remove();
                    g = null;
                    b.style.overflow = "none" }, 350) }, 10) } };
    a.afui.actionsheet =
        function(g) {
            return a(document.body).actionsheet(g) }
})(jQuery);
(function(a) {
    a.afui.registerDataDirective("[data-grower]", function(h, g) {
        ...
        a(c).one("panelload", function() { d.vendorCss("Transform", "");
            a(c).trigger("panelgrowcomplete", [b.get(0)]) })
    });
    a.afui.registerDataDirective("[data-grower-back]", function(h) {
        ...
        g.transition().end(function() { g.removeClass("active");
            b.trigger("panelgrowendstart");
            a.afui.loadContent(f, !1, !1, "none") }).run("translate3d(" + h.left + "px," + h.top + "px,0) scale(" + h.x + "," + h.y + ")", "300ms")
    })
})(jQuery);
(function(a) {
    function h(a, b, c, e) {
    ...
    function g() { b.last && Date.now() - b.last >= e && (b.el.trigger("longTap"), b = {}) }
    var b = {},
        f, e = 750,
        c, d = !1,
        m = !1;
    a(document).ready(function() {
        var l;
        a(document.body).bind("touchstart", function(h) {
            h.originalEvent && (h = h.originalEvent);
            if (h.touches && 0 !== h.touches.length) {
                var k = Date.now(),
                    r = k - (b.last || k);
                h.touches && 0 !== h.touches.length && (b.el = a("tagName" in h.touches[0].target ? h.touches[0].target :
            ...
            if (!m && (5 < Math.abs(b.x2 -
                    b.x1) || 5 < Math.abs(b.y2 - b.y1))) {
            ...
            function(c) {
                ...
                if (b.el)
                    if (a.afui.useAutoPressed && !b.el.attr("data-ignore-pressed") && b.el.removeClass("pressed"), b.isDoubleTap) b.el.trigger("doubleTap"), b = {};
                    else if ((0 < b.x2 || 0 < b.y2) && (30 < Math.abs(b.x1 - b.x2) || 30 < Math.abs(b.y1 - b.y2))) {
                    b.el.trigger("swipe");
                    c = h(b.x1, b.x2, b.y1, b.y2);
                    var e = ".x-scroll",
                        d = ".swipe-x";
                    if ("up" === c.toLowerCase() || "down" === c.toLowerCase()) e = ".y-scroll", d = ".swipe-y";
                    d = b.el.closest(d);
                    e = b.el.closest(e);
                    (0 === d.length || 0 === e.length || 0 === d.find(e).length) &&
                    b.el.trigger("swipe" + c);
                    b.x1 = b.x2 = b.y1 = b.y2 = b.last = 0
                } else "last" in b && (b.el.trigger("tap"), f = setTimeout(function() { f = null;
                    b.el && b.el.trigger("singleTap");
                    b = {} }, 250))
            }).bind("touchcancel", function() { b.el && (a.afui.useAutoPressed && !b.el.attr("data-ignore-pressed")) && b.el.removeClass("pressed");
            b = {};
            clearTimeout(c) })
    });
    "swipe swipeLeft swipeRight swipeUp swipeDown doubleTap tap singleTap longTap".split(" ").forEach(function(b) { a.fn[b] = function(a) {
            return this.bind(b, a) } })
})(jQuery);
(function(a) {
    var h = a.afui.setTitle;
    a.afui.animateHeader = function(g) {
        a.afui.setTitle = !1 !== g ? function(b, f, e, c) {
            var d;
            "string" === typeof b ? d = b : a(b).attr("data-title") ? d = a(b).attr("data-title") : a(b).attr("title") && (d = a(b).attr("title"));
            d && 0 !== d.length && (b = a(this.activeDiv).closest(".view").children("header").eq(0), e = e ? "header-unload" : "header-load", f = b.find("h1").eq(0).html(), b.find("h1").eq(0).html(d).removeClass("header-unload header-load"), c || (b.find("h1").animation().run(e + "-to"), c = a("<h1>" + f + "</h1>"),
                b.append(c), c.animation().end(function() { a(this).remove() }).run(e)))
        } : h
    }
})(jQuery);
(function(a) {
    ...
    var h = [],
        g = function(b, e) {
            if (this.container = "string" === typeof b || b instanceof String ? document.getElementById(b) : b) try {
                if ("string" === typeof e || "number" === typeof e) e = { message: e, cancelOnly: "true", cancelText: "OK" };
                ...
                this.cancelText = e.cancelText ||
                    "Cancel";
                this.cancelCallback = e.cancelCallback || function() {};
                this.cancelClass = e.cancelClass || "button";
                this.doneText = e.doneText || "Done";
                this.doneCallback = e.doneCallback || function() {};
            ...
            } catch (c) { console.log("error adding popup " + c) } else window.alert("Error finding container for popup " + b)
        };
    g.prototype = {
        id: null,
        addCssClass: null,
        ...
        show: function() {
            var b = this,
                e = a("<div id='" + this.id + "' class='afPopup hidden " + this.addCssClass + "'><header>" + this.title + "</header><div>" + this.message + "</div><footer><a href='javascript:;' class='" + this.cancelClass + "' id='cancel'>" + this.cancelText + "</a><a href='javascript:;' class='" + this.doneClass +
                    "' id='action'>" + this.doneText + "</a><div style='clear:both'></div></footer></div>");
            a(this.container).append(e);
            e.bind("close", function() { b.hide() });
            this.cancelOnly && (e.find("A#action").hide(), e.find("A#cancel").addClass("center"));
            e.find("A").each(function() {
                var c = a(this);
                c.bind("click", function(a) { "cancel" === c.attr("id") ? (b.cancelCallback.call(b.cancelCallback, b), b.hide()) : (b.doneCallback.call(b.doneCallback, b), b.autoCloseDone && b.hide());
                    a.preventDefault() }) });
            b.positionPopup();
            a.blockUI(0.5);
            e.bind("orientationchange",
                function() { b.positionPopup() });
            e.find("header").show();
            e.find("footer").show();
            setTimeout(function() { e.removeClass("hidden").addClass("show");
                b.onShow(b) }, 50)
        },
        hide: function() {
            var b = this;
            a.query("#" + b.id).addClass("hidden");
            a.unblockUI();!a.os.ie && !a.os.android ? setTimeout(function() { b.remove() }, 250) : b.remove() },
        remove: function() {
    ...
    var b = !1;
    a.blockUI = function(f) { b || (f = f ? " style='opacity:" + f + ";'" : "", a.query("BODY").prepend(a("<div id='mask'" + f + "></div>")), a.query("BODY DIV#mask").bind("touchstart", function(a) { a.preventDefault() }), a.query("BODY DIV#mask").bind("touchmove", function(a) { a.preventDefault() }), b = !0) };
    a.unblockUI = function() { b = !1;
        a.query("BODY DIV#mask").unbind("touchstart");
        a.query("BODY DIV#mask").unbind("touchmove");
        a("BODY DIV#mask").remove() };
    a.afui.registerDataDirective("[data-alert]", function(b) { b = a(b).attr("data-message");
        0 !== b.length && a(document.body).popup(b) });
    a.afui.popup = function(b) {
        return a(document.body).popup(b) }
})(jQuery);
(function(a) {
    function h(a) { this.element = a;
        this.element.classList.remove("animation-reverse");
        this.keepClass = !1 }

    function g(a) { this.element = a;
        this.element }
    a.fn.animation = function() {
        var a = this;
        this.each(function() { a = new h(this) });
        return a };
    var b = function(a) {
        ...
        this.endcb && this.endcb.call(this.element,
            a);
        this.element.classList.remove("animation-reverse");
    ...
    h.prototype = {
        ...
        runEnd: !1,
        keepClass: !1,
        keep: function() { this.keepClass = !0;
            return this },
        remove: function(a) { this.element.classList.remove(a);
        ...
        run: function(a, c) {
            ...
            if (this.runEnd) return this.endCBCache(), this;
            ...
            this.element.addEventListener("MSAnimationEnd",
                this.endCBCache, !1);
            return this
        },
        reverse: function() { this.element.classList.add("animation-reverse");
            return this },
        reRun: function(a) { this.remove(a);
            return this.run(a) },
        endcb: function() {},
        end: function(a) { this.endcb = a;
            return this }
    };
    a.fn.transition = function() {
        var a = this;
        this.each(function() { a = new g(this) });
        return a };
    var f = function(b) {
        ...
        this.element.removeEventListener("MSTransitionEnd",
            this.endCBCache, !1);
    ...
    g.prototype = {
        ...
        run: function(b, c) {
            ...
            this.element.addEventListener("MSTransitionEnd",
                this.endCBCache, !1);
            a(this.element).vendorCss("TransitionDuration", c);
            a(this.element).vendorCss("Transform", b);
            this.timer = setTimeout(function() { this.endCBCache() }.bind(this), parseInt(c, 10) + 50);
            return this
        },
        endcb: function() {},
        end: function(a) { this.endcb = a;
...
(function(a) { a.afui.ready(function() { setTimeout(function() { a("#splashscreen").remove() }, 250) }) })(jQuery);
(function(a) {
    function h() {
        return this }
    var g = null,
        b, f = { push: function(b, c, d) { b = a(b).closest(".view").children().filter(":not(nav):not(aside)");
                d = d || g;
                for (var f = 0; f < b.length; f++) {
                    var h = a(b[f]).show().animation();
                    c ? h.remove("slide-" + d + "-out").reverse() : h.keep();
                    h.run("slide-" + d + "-out") } }, cover: function() {}, reveal: function(a, b) {
                return this.push(a, b) } };
    h.prototype = {
        defaultTransition: "slide",
        defaultAnimation: "cover",
        isTransitioning: !1,
        autoHide: function(a) { a.preventDefault();
            this.hide() },
        checkViewToClose: function(a) { this.autoHide(a) },
        autoHideCheck: null,
        ...
        show: function(e, c, d) {
            if (!this.isTransitioning) {
                ...
                l && (b = l, l.classList.contains("active") || (this.isTransitioning = !0, this.autoHideCheck = this.autoHide.bind(this), a(l).closest(".view").children().filter(":not(nav):not(aside)").off("touchstart", this.autoHideCheck), l.classList.add(g), e = a(l).show(), c = "right" === g ? "left" : "right", 0 < a(l).closest(".view").find(".slide-" +
                        c + "-out").length && (a(l).closest(".view").find(".slide-" + c + "-out").removeClass("slide-" + c + "-out"), a(l).closest(".view").find("aside.active, nav.active").removeClass("left right active").hide()), "reveal" !== d ? e.css("zIndex", "999").animation().run("slide-" + g + "-in").end(function() { this.classList.add("active");
                        h.isTransitioning = !1 }) : e.animation().run("blank").end(function() { a(this).css("zIndex", "999");
                        this.classList.add("active");
                        h.isTransitioning = !1 }), l.activeAnimation = d, l.activePosition = g, l.toggled = !0,
                    f[d](l, !1), setTimeout(function() { a(l).closest(".view").children().filter(":not(nav):not(aside)").on("touchstart", h.autoHideCheck) }), this.selfCheckViewToClose = h.checkViewToClose.bind(this), a(l).bind("nestedviewunload", this.selfCheckViewToClose)))
            }
        },
        hide: function(e, c) {
            if (!this.isTransitioning) {
                ...
                if (g && g.toggled) {
                    a(g).closest(".view").children().filter(":not(nav):not(aside)").off("touchstart",
                        this.autoHideCheck);
                    var h = c || g.activePosition,
                        p = a(g).animation();
                    "reveal" === g.activeAnimation && a(g).css("zIndex", "1");
                    var k = "reveal" === g.activeAnimation ? "blank" : "slide-" + h + "-in";
                    p.reverse().reRun(k).end(function() { this.classList.remove("active");
    ...
    a.afui.registerDataDirective("[data-menu-close]", function(b) {
        var c = a(b),
            d = null;
...
(function(a) {
    ...
    a(document).on("swipeStartLeft", ".swipe-reveal", function(c, d, m) { m.preventDefault();
        h = a(c.target).closest(".swipe-content");
        g = d.x2;
        f = h.closest(".swipe-reveal").find(".swipe-hidden").width();
        0 === a.getCssMatrix(c.target).e && (h.bind("touchmove", e), h.one("touchend", function() { h.unbind("touchmove", e);
            Math.abs(b) / f < a.afui.swipeThreshold && (f = 0);
            h.transition().keep().end(function() { h = f = null }).run("translate3d(" + -f + "px,0px,0)", "100ms") })) });
    a(document).on("swipeStartRight",
        ".swipe-reveal",
        function(c, d, m) { m.preventDefault();
            h = a(c.target).closest(".swipe-content");
            f = h.closest(".swipe-reveal").find(".swipe-hidden").width();
            0 === a(c.target).parents(".swipe-content").length && 0 === a.getCssMatrix(c.target).e || (g = d.x2 + f, h.bind("touchmove", e), h.one("touchend", function() { h.unbind("touchmove", e);
...
(function(a) {
    ...
    if (!a.os.supportsTouch) {
        ...
        var b = function(a) { a.preventDefault();
                a.stopPropagation() },
            ...
            c = function(b, c, d, f) {
                ...
                f.mouseToTouch = !0;
                if (a.os.ie)
                    for (c = c.target; null !== c;) c.hasAttribute("on" + b) && eval(c.getAttribute("on" +
                        b)), c = c.parentElement;
                d.dispatchEvent(f)
            },
            d = !1,
            ...
            l = 0,
            p = 0;
        window.navigator.msPointerEnabled ? (document.addEventListener("MSPointerDown", function(a) { d = !0;
            m = a.target; "a" === a.target.nodeName.toLowerCase() && "javascript:;" === a.target.href.toLowerCase() && (a.target.href = "");
            c("touchstart", a, null, !0);
            h = !1;
            l = a.clientX;
            p = a.clientY;
            return !0 }, !0), document.addEventListener("MSPointerUp", function(a) {
            if (d) return c("touchend", a, m, !0), m = null, d = !1, !0 }, !0), document.addEventListener("MSPointerMove", function(a) {
            if (!(Math.abs(a.clientX -
                    l) <= f || Math.abs(a.clientY - p) <= f) && d) return c("touchmove", a, m, !0), h = !0
        }, !0)) : (document.addEventListener("mousedown", function(a) { d = !0;
            m = a.target; "a" === a.target.nodeName.toLowerCase() && "javascript:;" === a.target.href.toLowerCase() && (a.target.href = "#");
            c("touchstart", a);
            h = !1;
            l = a.clientX;
            p = a.clientY }, !0), document.addEventListener("mouseup", function(a) { d && (c("touchend", a, m), m = null, d = !1) }, !0), document.addEventListener("mousemove", function(a) {!(a.clientX === l && a.clientY === p) && d && (c("touchmove", a, m), h = !0) }, !0));
        ...
        document.addEventListener("selectstart", function(a) { e(a, a.target) }, !0);
        document.addEventListener("click", function(a) {!a.mouseToTouch && a.target === m && b(a);
            h && (b(a), h = !1) }, !0)
    }
})(jQuery, window);
(function(a) {
    ...
    var h = function() {
        var g = function(b, f) {
            if (this.container = "string" === typeof b || b instanceof String ? document.getElementById(b) : b) {
                if ("string" === typeof f || "number" === typeof f) f = { message: f };
                ...
                0 === this.container.find(".afToastContainer").length &&
                ...
                !1 === f.autoClose && (this.autoClose = !1);
                this.show()
        ...
        g.prototype = {
            ...
            show: function() {
                ...
                f.addClass("hidden");
                setTimeout(function() { f.css("height", e);
                    f.removeClass("hidden") }, 20);
                this.autoClose && (this.timer = setTimeout(function() { b.hide() }, this.delay));
                f.bind("click", function() { b.hide() })
            },
            hide: function() {
                var b = this;
                clearTimeout(this.timer);
                a(this.el).unbind("click").addClass("hidden");
                a(this.el).css("height", "0px");!a.os.ie && !a.os.android ? setTimeout(function() { b.remove() }, 300) : b.remove() },
            remove: function() { a(this.el).remove() }
        };
        return g
    }();
    a.afui.toast = function(g) { a(document.body).toast(g) };
    a.afui.registerDataDirective("[data-toast]", function(g) {
        var b = a(g);
        ...
        if (0 !== g.length) {
            ...
            g = { message: g, position: f, delay: b, autoClose: c, type: e };
...
(function(a) {
    ...
    h.prototype = {
        ...
        renderKeyboard: function() {
            for (var a = "", b = 0; 8 > b; b += 3) {
                for (var a = a + "<div class='row'>", f = 1; 3 >= f; f++) var e = b + f,
        ...
        show: function() {
            if (!this.visible) {
                ...
                var f = a("#lockScreen input[type='password']"),
                    e = this;
                a(b).on("click", function(b) { b = a(b.target);
                    if (0 !== b.length && (b = b.attr("data-key"))) "delete" === b ? f.val(f.val().substring(0, f.val().length - 1)) : (4 > f.val().length && f.val(f.val() + b), 4 === f.val().length && (e.validatePassword(f.val()) ? e.hide() : (e.lockscreen.find(".error").css("visibility", "visible"), setTimeout(function() { e.lockscreen.find(".error").css("visibility", "hidden");
                        f.val("") }, 1E3)))) });
                a(b).on("touchstart", function(b) { a(b.target).addClass("touched") }).on("touchend",
                    function(b) { a(b.target).removeClass("touched") })
            }
        },
        hide: function() { this.lockscreen && this.lockscreen.remove() }
    }
})(jQuery);
